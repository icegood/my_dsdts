 ...
 *
 * Disassembly of SSDT-4.aml, Sat Mar 28 23:45:20 2020
 *
...
DefinitionBlock ("", "SSDT", 2, "CpuRef", "CpuSsdt", 0x00003000)
{
    ...
    {
        Name (CTPC, Zero)
        OperationRegion (PNVS, SystemMemory, 0x29981000, 0x006B)
    ...
    Scope (\_PR.CPU0)
    {
        ...
        Method (COSC, 4, NotSerialized)
        {
            ...
            If (Not (And (STS0, One)))
            {
                ...
                Else
                {
                    ...
                    Store (0x28, IOB2) /* \_PR_.CPU0.COSC.IOB2 */
                }
            }
        ...
        Method (GCAP, 1, NotSerialized)
        {
            ...
            If (LNot (And (PDC0, 0x1000)))
            {
                ...
                Store (0x27, IOB2) /* \_PR_.CPU0.GCAP.IOB2 */
            }
